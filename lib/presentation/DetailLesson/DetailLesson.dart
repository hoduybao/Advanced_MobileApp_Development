import 'package:advanced_mobileapp_development/presentation/DetailLesson/lesson.dart';
        ...
        body: SingleChildScrollView(
            child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: Colors.grey,
                        width: 0.5), // Màu nền của container
                    borderRadius: BorderRadius.circular(
                        2), // Độ bo tròn góc của container
                  ),
                  child: Column(
                    children: [
                      Container(
                              ...
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) =>  Lesson(title: topics[index], url: "https://api.app.lettutor.com/file/be4c3df8-3b1b-4c8f-a5cc-75a8e2e6626afileThe%20Internet.pdf")),
                                    );
                                    setState(() {
