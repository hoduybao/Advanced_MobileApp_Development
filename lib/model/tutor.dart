...
class TutorDTO {
  ...
  factory TutorDTO.fromJson(Map<String, dynamic> json) {
    return TutorDTO(
      ...
      feedbacks: List<FeedbackDTO>.from(json['feedbacks'].map((x) => FeedbackDTO.fromJson(x))),
      id: json['id'],
      userId: json['userId'],
      video: json['video'],
      bio: json['bio'],
      ...
      specialties: json['specialties']!=null?TutorDTO.convertStringToSpecialties(json['specialties']):[],
      resume: json['resume'],
      rating: json['rating'],
