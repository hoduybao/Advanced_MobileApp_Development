                ...
                if(valueReason!=null)
                  {
                    ...
                    callApiCancelClass(valueReason!,textEditingController.text,widget.schedule.id!,BookingRepository(),authProvider);
                    Navigator.of(context).pop();
...
Future<void> callApiCancelClass(String cancelReasonId,String note,String scheduleDetailId,
