                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: generateRatings(tutorData.rating!=null?tutorData.rating!:0.0)
                          ),
                          SizedBox(
                            height: 10,
                          ),
                          Row(
                            children: [
                              SvgPicture.network("https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.4.3/flags/4x3/"+
                                widget.tutor.country.toString().toLowerCase()+".svg", // Replace with the path to your SVG file
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          IconButton(
                              onPressed: () {
                                widget.changeFavorite(tutorData.userId!);
                              },
                              icon: Icon(
